...
class Book {
    ...
    private int pubYear;
    private String isbn;
    public Book(String t) {title = t;}// ... completar 
    public Book(String t, int y) {title = t; pubYear = y;}// ... completar 
    public Book(String t, int y, String i) {title = t; pubYear = y; isbn = i;}// ... completar 
    ...
    public String toString() {
        ...
        return "Livro de titulo: " + this.title + "ano de publicação: " + this.pubYear + "e de isbn: " + this.isbn;
